          ...
          @include('admin.layout._operation_status')  
           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="margin-top: 25px;">
                  <label class="col-sm-3 col-lg-2 control-label">Skill<i style="color: red;">*</i></label>
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="skill_name" placeholder="Enter Skill" data-rule-required="true" value="{{ isset($arr_data['skill_name'])?$arr_data['skill_name']:'' }}" />
                      <span class="help-block">{{ $errors->first('skill_name') }}</span>
                  </div>
            </div>
