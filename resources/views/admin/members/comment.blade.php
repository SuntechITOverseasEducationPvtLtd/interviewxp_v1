           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" >
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <textarea style="height:200px; width:800px;" class="form-control" name="comment" placeholder="Enter Comment" data-rule-required="true" data-rule-maxlength="200" />{{$arr_member_info['admin_comments'] or ''}}</textarea>
