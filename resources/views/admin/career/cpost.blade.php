           ...
           {{ csrf_field() }}
            <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-6 controls" >
                      <input type="text" class="form-control" name="job_name" placeholder="Eg. PHP Developer" data-rule-required="true" required  value="" />
                 ...
                 <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-6 controls" >
											...
											<label class="radio-inline">
												<input type="radio" class="styled" value="1" name="jobtype" checked="checked">
												Regular In office/On field
											</label>

											<label class="radio-inline">
												<input type="radio" class="styled" value="2" name="jobtype">
												Work from Home
											</label>
									
										<label class="radio-inline">
												<input type="radio" class="styled"  value="3" name="jobtype">
              ...
              <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-6 controls" >
                      <input type="text" class="form-control" name="job_opening" placeholder="Eg. 5" data-rule-required="true" required  value="" />
              ...
              <div class="form-group" style="margin-top: 25px;">
               ...
               <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-6 controls" >
                   <textarea class="form-control"  placeholder="Page Content" name="page_desc" cols="50" rows="10"></textarea>
               ...
               <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-6 controls" >
                      <input type="email" class="form-control" name="email" placeholder="Eg. example@gmail.com" data-rule-required="true" required  value="job@interviewxp.com" />
               ...
               <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-6 controls" >
                      <input type="text" class="form-control" name="phone" placeholder="Eg. 9898789878" data-rule-required="true" required  value="+91 7674995598" />
            ...
            <div class="form-group">
              <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                     <input type="hidden"  name="savevalue" class="savevalue" data-rule-required="true" required  value="1" />
                     
                  
                {!! Form::submit('Draft',['class'=>'btn   btn-danger saveh','value'=>'1','name'=>'draft'])!!}
                 {!! Form::submit('Save',['class'=>'btn  btn-primary drafth','value'=>'2' ,'name'=>'save'])!!}
                 
                  {!! Form::submit('Post Job',['class'=>'btn bg-teal-400 posth','value'=>'3','name'=>'post'])!!}
              </div>
            </div>
