         ...
         <tr>
            <td bgcolor="#FFFFFF" style="border:1px solid #e5e5e5;">
               <table style="margin-bottom: 0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr><td style="color: #333333;font-size: 15px;padding-top: 3px;text-align: center; font-family: robotomedium;">Reset Password</td></tr>
                  ...
                  <tr>
                   ...
                   Hello <span style="color: #fc575c;font-family: 'ubuntumedium',sans-serif;">{{isset($arr_built_content['FIRST_NAME'])?$arr_built_content['FIRST_NAME']:'Sir/Mam'}}, </span>
                     </td>
                  </tr>
               <tr>
                     <td style="color: #545454;font-size: 15px;padding: 12px 30px;">
                   Thank you for your interest in {{config('app.project.name')}} !
               ...
               <tr>
                  ...
                  <tr>
                  <td class="listed-btn">
                  <!-- {{isset($arr_mail_data['arr_built_content']['REMINDER_URL'])?$arr_mail_data['arr_built_content']['REMINDER_URL']:''}} -->

                  
                  <a href="{{$arr_built_content['REMINDER_URL']}}">Reset Password</a>
                  </td></tr>
                  <tr>
                     <td height="40"></td>
                  </tr>
                     ...
                     <table style="margin-bottom: 0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td style="font-family: 'robotomedium',sans-serif; font-size:13px;background: rgb(17, 18, 24) none repeat scroll 0% 0%; text-align: center; color: rgb(255, 255, 255); padding: 12px;">
                              Copyright © 2016 The {{config('app.project.name')}}. All Rights Reserved.
                           </td>
