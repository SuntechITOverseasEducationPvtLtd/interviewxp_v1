           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="qualification_name" placeholder="Enter Qualification" data-rule-required="true" {{-- data-rule-lettersonly="true" --}}  value="{{ isset($arr_data['qualification_name'])?$arr_data['qualification_name']:'' }}" />
