                ...
                <?php $i=1; ?>
                  ...
                  <tr>
                     ...
                     <td> 
                       ...
                       @if($data['is_active']==1)
                       <td style="font-weight:bold;color:green">Active</td>
                       @else
                       <td style="font-weight:bold;color:red">Block</td>
                     ...
                     <!--  <td><a href="{{ $module_url_path.'/comment/'.base64_encode($data['id']) }}">
                      ...
                      @endif
                       ...
                       <td class="ac-icons"> 
                        <span> <a href="{{ $module_url_path.'/details/'.base64_encode($data['id']) }}" class="admin-button-icons call_loader">
                        <i class="glyphicon glyphicon-eye-open" title="View" ></i><p>View</p>
                        </a>  </span>
                         
                        &nbsp;
                        <span> <a href="{{ $module_url_path.'/edit/'.base64_encode($data['id']) }}" class="admin-button-icons call_loader">
                        <i class="fa fa-edit" title="Edit" ></i><p>Edit</p>
                        </a>  </span>
                       
                        &nbsp;  
                        <span><a href="{{ $module_url_path.'/delete/'.base64_encode($data['id'])}}"  
                           onclick="return confirm_delete();" class="admin-button-icons call_loader">
