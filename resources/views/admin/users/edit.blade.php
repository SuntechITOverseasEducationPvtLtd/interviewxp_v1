          ...
          @include('admin.layout._operation_status')  
           ...
           @if(isset($arr_data) && sizeof($arr_data)>0)
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input readonly="" type="text" class="form-control" name="email" placeholder="Enter Email" data-rule-required="true" data-rule-email="true" value="{{ isset($arr_data['email'])?$arr_data['email']:'NA' }}" />
             ...
             <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                     ...
                     <div class="select-number">
                               <!--  <select class="form-control"  name="mobile_code" data-rule-required="true">
                                   <option @if($arr_data['mobile_code']=='+91') selected="" @endif value="+91">+91</option>
                                   <option @if($arr_data['mobile_code']=='+92') selected="" @endif value="+92">+92</option> 
                                   <option @if($arr_data['mobile_code']=='+93') selected="" @endif value="+93">+93</option>
                                   <option @if($arr_data['mobile_code']=='+94') selected="" @endif value="+94">+94</option>
                                   <option @if($arr_data['mobile_code']=='+95') selected="" @endif value="+95">+95</option>
                                 </select> -->
                                 <input type="text" class="form-control" name="mobile_code" placeholder="+91" data-rule-required="true" data-rule-pattern="\+[0-9]{1,3}" value="{{ isset($arr_data['mobile_code'])?$arr_data['mobile_code']:'NA' }}" />
            ...
            <div class="form-group" style="">
                ...
                <div class="col-sm-9 col-lg-4 controls" >
                    <select class="form-control"  name="qualification_id" data-rule-required="true" id="qualification_id" onclick="loadSpecialization(this);"  >
            ...
            <div id="outside_india" style="display:none;">
              <div class="form-group">
                  <label class="col-sm-3 col-lg-2 control-label">Country<i style="color: red;">*</i></label>
                        <div class="col-sm-9 col-lg-4 controls" >
                        <div class="select-number">
                           <select class="form-control" id="country_id" name="country_id" data-rule-required="false">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls" >
                           <input type="text" class="form-control" id="city_name"  name="city_name" placeholder="Enter your city name here" value="{{ $arr_data['user_profile']['other_city'] or '' }}"" data-rule-required="false"/>
                ...
                <div class="col-sm-9 col-lg-10 controls">
                   <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px; text-align: center;">
                        <img src= {{ $user_profile_public_img_path.$arr_data['profile_image']}}  alt="" style="height:100%" />
                          
                      </div>
                      <div class="fileupload-preview fileupload-exists img-thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px; text-align: center;"></div>
                      <div>
