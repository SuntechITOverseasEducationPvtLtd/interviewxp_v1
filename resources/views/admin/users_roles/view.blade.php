...
.panel {
 ...
 <div class="row">
  <div class="col-md-12">
           ...
           {{ csrf_field() }}
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-9 col-lg-9 controls" >
                      <input type="text" class="form-control" name="rolename" value="{{ $arr_data['rolename'] }}" data-rule-required="true" readonly data-rule-maxlength="255" />
    ...
    padding-bottom: 6px;">
										<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Privileges For Current Role</span></h5>
           ...
           @if(sizeof($arr_roles)>0)
             ...
             <div class="col-sm-12 col-lg-12 controls" > 
                ...
                <div class="panel panel-flat">
						  ...
						  if($roledatacoiunt==1) { $checkd="checked";  $checkds="block"; } else { $checkd="";  $checkds="none";}
						  
						  ?> 
						  
							<div class="list-group-item" style="display:{{$checkds}}"><div class="checkbox ubuntuRegText">
                              <label>
