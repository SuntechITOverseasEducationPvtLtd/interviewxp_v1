...
.panel {
  ...
  <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="submit"  class="btn btn-primary" value="Add Role">
                  ...
                  <div class="col-sm-9 col-lg-9 controls" >
                      <input type="text" class="form-control" name="rolename" value="{{ old('rolename') }}" data-rule-required="true" data-rule-maxlength="255" />
    ...
    padding-bottom: 6px;">
										<h5><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Set Privileges For Current Role</span></h5>
                ...
                <div class="panel panel-flat">
						  ...
						  @foreach($roledata as $roledataF)	    
							<div class="list-group-item"><div class="checkbox ubuntuRegText">
                              <label>
                                <input type="checkbox" name="roleselect[]" value="{{ $arr_rolesF['id']}}-{{ $roledataF->id}}" > <font>{{ $roledataF->rolename}}</font>
