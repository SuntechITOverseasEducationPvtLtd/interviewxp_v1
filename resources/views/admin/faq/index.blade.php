    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <div class="btn-group">
          <a href="{{ $module_url_path.'/create' }}" class="btn btn-primary btn-add-new-records call_loader" title="Add New Property Type">Add FAQ</a> 
          </div>
              ...
              <tbody>
                ...
                @if(sizeof($arr_data)>0)
                  ...
                  <tr>
                    ...
                    <td> 
                        <a href="{{ $module_url_path.'/edit/'.base64_encode($data['id']) }}" title="Edit" class="call_loader">
                        ...
                        <a href="{{ $module_url_path.'/delete/'.base64_encode($data['id']) }}"  
                           ...
                           title="Delete" class="call_loader">
