              ...
              <div id="myTabContent1" class="tab-content">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                        {!! Form::text('page_title',old('page_title'),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255','placeholder'=>'Page Title']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                        {!! Form::text('meta_keyword',old('meta_keyword'),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255','placeholder'=>'Meta Keyword']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                        ...
                        {!! Form::text('meta_desc',old('meta_desc'),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255','placeholder'=>'Meta Description']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-8 controls">
                        {!! Form::textarea('page_desc',old('page_desc'),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'1000','placeholder'=>'Page Content']) !!}
