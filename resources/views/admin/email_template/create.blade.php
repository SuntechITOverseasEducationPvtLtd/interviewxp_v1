...
<?php      	$usertcategroy= DB::table('tbl_mail_category') ->where(['status'=>1])->get(); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                       <select class="form-control" name="template_category">
                           ...
                           <?php foreach($usertcategroy as $usertcategroyF) { ?>
                           <option value="{{$usertcategroyF->id}}">{{$usertcategroyF->name}}</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                        ...
                        {!! Form::text('subject',old('subject'),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255','placeholder'=>'Subject']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-8 controls">
                     Use variable-  (%first_name%, %last_name%, %user_name%, %password%, %email%, %approvestatus%)<br>
                        {!! Form::textarea('mailbody',old('mailbody'),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'1000','placeholder'=>'Body Content']) !!}
