                ...
                <div class="box-content">
                    ...
                    {!! Form::open([ 'url' => $module_url_path.'/update/'.base64_encode($arr_data['site_setting_id']),
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls">
                                {!! Form::text('site_contact_number',isset($arr_data['site_contact_number'])?$arr_data['site_contact_number']:'',['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'16', 'data-rule-digits'=>'true']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls">
                                {!! Form::text('rss_feed_url',isset($arr_data['rss_feed_url'])?$arr_data['rss_feed_url']:'',['class'=>'form-control','data-rule-required'=>'', 'data-rule-url'=>'', 'data-rule-maxlength'=>'500']) !!}
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 col-lg-2 control-label">Email Logo<i style="color: red;">*</i> </label>
                          <div class="col-sm-9 col-lg-10 controls">
                             <div class="fileupload fileupload-new" data-provides="fileupload">
                               <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                  <img src={{ $logo_img_path.'/'.$arr_data['email_logo_image']}} alt="" />  
                              </div>
                                ...
                                <div>
                                   ...
                                   {!! Form::file('email_logo_image',['id'=>'email_logo_image','class'=>'file-input','data-rule-required'=>'true']) !!}
                              ...
                              <span class='help-block'><b>{{ $errors->first('email_logo_image') }}</b></span>  
                          </div>
                        </div>

                        <hr/>
                        <div class="form-group">
                          <label class="col-sm-3 col-lg-2 control-label">WebSite Logo<i style="color: red;">*</i> </label>
                          <div class="col-sm-9 col-lg-10 controls">
                             <div class="fileupload fileupload-new" data-provides="fileupload">
                               <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                  <img src={{ $logo_img_path.'/'.$arr_data['website_logo_image']}} alt="" />  
                              </div>
                                <div class="fileupload-preview fileupload-exists img-thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;">
                                     <img src={{ $logo_img_path.'/'.$arr_data['website_logo_image']}} alt="" />  
                                </div>
                                <div>
                                   ...
                                   {!! Form::file('website_logo_image',['id'=>'website_logo_image','class'=>'file-input','data-rule-required'=>'true']) !!}
                              ...
                              {{-- <i style="color:#ff6666;">Please use 140 x 140 pixel image for best result ,<br/> allowed only JPG, JPEG and PNG image</i> --}}
                              <span class='help-block'><b>{{ $errors->first('website_logo_image') }}</b></span>  
                          </div>
                        </div>
