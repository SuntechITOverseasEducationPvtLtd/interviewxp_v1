              ...
              <tbody>
                ...
                @if(isset($arr_data) && sizeof($arr_data)>0)
                  ...
                  <tr>
                    ...
                    <td > {{ $data['qualification']['qualification_name'] }} </td> 
                    ...
                    <td> <div class="forleft">
                      ...
                      </a>   <p class="myp">Edit</p>
                     </div>
                        &nbsp;  <div class="forleft"> 
                      <a href="{{ $module_url_path.'/delete/'.base64_encode($data['id'])}}"  
                        onclick="return confirm_delete();" class="myc call_loader btn border-warning-400 text-warning-400 btn-flat btn-rounded btn-icon btn-xs valign-text-bottom">
                    <i class="icon-trash" title="Delete"></i>  
                      </a>   <p class="myp">Del</p> </div>   
                    </td>
                  </tr>
                  @endforeach
                @endif
