        ...
        <div class="box-content">
          ...
          <table class="datatable table table-striped table-bordered">
             ...
             <th>Month</th> 
                     ...
                     <th>TDS</th>
                     <th>Member Payments after tax</th>
                     <th>View</th>
              ...
              <tbody>
                @if(isset($entries) && sizeof($entries)>0)
                  ...
                  <tr>
                     ...
                     <a href="{{url('/admin/transactions/payments/'.base64_encode($data[0]).'/'.base64_encode($data[1]))}}" class="btn border-warning-400 text-warning-400 btn-flat btn-rounded btn-icon btn-xs valign-text-bottom" style="float: left;"><i class=" icon-calendar52"></i></a>
                     ...
                     <a href="{{url('/admin/transactions/payments/'.base64_encode($data[0]).'/'.base64_encode($data[1]))}}">{{$data[2]}} </a></td>
					 ...
					 {{ number_format($data[11],2) }}
                      ...
                      <td> 
                        <span> <a href="{{url('/admin/transactions/payments/'.base64_encode($data[0]).'/'.base64_encode($data[1]))}}" class="myc admin-button-icons call_loader btn border-indigo-400 text-indigo-400 btn-flat btn-rounded btn-icon btn-xs valign-text-bottom">
                        <i class=" icon-zoomin3" title="View"></i>
                        </a>  <p class="myp">View</p> </span>
                     </td>
                  </tr>
                  @endforeach
