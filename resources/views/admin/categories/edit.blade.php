           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="category_name" placeholder="Enter Category" data-rule-required="true" {{-- data-rule-lettersonly="true" --}}  value="{{ isset($arr_data['category_name'])?$arr_data['category_name']:'' }}" />
