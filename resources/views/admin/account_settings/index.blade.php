...
<div class="panel panel-flat">
  ...
  <div class="panel-body">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <label class="col-sm-3 col-lg-2 control-label">Deactivate Company Q&A Tab
            <i class="red">*
            </i>
          </label>
          <div class="col-sm-9 col-lg-4 controls">
            <input type="checkbox" name="deactivate_company_tab" value="1" {!! ($arr_account_detail['deactivate_company_tab']) ? 'checked' : '' !!} /> 
            <span class='help-block'>{{ $errors->first('deactivate_company_tab') }}
            </span>
          </div>
        </div>
		 ...
		 <div class="form-group">
          <label class="col-sm-3 col-lg-2 control-label">TDS</label>
          <div class="col-sm-9 col-lg-4 controls">
            {!! Form::text('tds',$arr_account_detail['tds'],['class'=>'form-control','data-rule-maxlength'=>'6','placeholder'=>'Enter TDS Percent']) !!}
            <span class='help-block'>{{ $errors->first('tds') }}
            </span>
          </div>
        </div>
		
		<div class="form-group">
          <label class="col-sm-3 col-lg-2 control-label">Admin Commission</label>
          <div class="col-sm-9 col-lg-4 controls">
            {!! Form::text('admin_commission',$arr_account_detail['admin_commission'],['class'=>'form-control','data-rule-maxlength'=>'6','placeholder'=>'Enter Admin Commission']) !!}
            <span class='help-block'>{{ $errors->first('admin_commission') }}
            </span>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-sm-3 col-lg-2 control-label">Enble GST?</label>
          <div class="col-sm-9 col-lg-4 controls">
            <input type="checkbox" name="is_enable_gst" value="1" {!! ($arr_account_detail['is_enable_gst']) ? 'checked' : '' !!} /> 
            <span class='help-block'>{{ $errors->first('is_enable_gst') }}
            </span>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 col-lg-4 controls">
            {!! Form::text('igst',$arr_account_detail['igst'],['class'=>'form-control','data-rule-maxlength'=>'6','placeholder'=>'Enter IGST Value']) !!}
            <span class='help-block'>{{ $errors->first('igst') }}
            </span>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 col-lg-4 controls">
            {!! Form::text('cgst',$arr_account_detail['cgst'],['class'=>'form-control','data-rule-maxlength'=>'6','placeholder'=>'Enter CGST Value']) !!}
            <span class='help-block'>{{ $errors->first('cgst') }}
            </span>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 col-lg-4 controls">
            {!! Form::text('sgst',$arr_account_detail['sgst'],['class'=>'form-control','data-rule-maxlength'=>'6','placeholder'=>'Enter SGST Value']) !!}
            <span class='help-block'>{{ $errors->first('sgst') }}
            </span>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
          <label class="col-sm-3 col-lg-2 control-label">Activation Fee
            <i class="red">*
            </i>
          </label>
          <div class="col-sm-9 col-lg-4 controls">
          <input type="text" class="form-control" name="activationfee"   placeholder="Member Activation Fee" value="{{isset($arr_account_detail['activationfee'])?$arr_account_detail['activationfee']:'NA'}}"   />
            <span class='help-block'>{{ $errors->first('activationfee') }}
            </span>
          </div>
        </div>
