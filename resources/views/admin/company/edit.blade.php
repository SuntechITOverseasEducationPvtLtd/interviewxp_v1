           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="company_name" placeholder="Enter Company" data-rule-required="true" {{-- data-rule-lettersonly="true" --}}  value="{{ isset($arr_data['company_name'])?$arr_data['company_name']:'' }}" />
            ...
            <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="company_location" placeholder="Enter Location" data-rule-required="true" {{-- data-rule-lettersonly="true" --}}  value="{{ isset($arr_data['company_location'])?$arr_data['company_location']:'' }}" />
