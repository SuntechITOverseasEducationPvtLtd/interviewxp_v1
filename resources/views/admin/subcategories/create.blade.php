          ...
          @include('admin.layout._operation_status')  
           ...
           <div class="form-group" style="">
            ...
            <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="subcategory_name" placeholder="Enter Category" data-rule-required="true" {{-- data-rule-lettersonly="true" --}}  value="{{ old('subcategory_name') }}" />
