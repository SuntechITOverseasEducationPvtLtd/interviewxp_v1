...
<?php $srno++; ?>
                  <tr>
                    <td> 
                      <input type="checkbox" 
                             name="checked_record[]"  
                             value="{{ base64_encode($data['city_id']) }}" /> 
                    </td>
                    ...
                    <td > {{ $data['city_name'] }} </td>
                       ...
                       <td>
                      @if($data['is_active']==1)
                        <a href="{{ $module_url_path.'/deactivate/'.base64_encode($data['city_id']) }}" class="btn border-teal text-teal btn-flat btn-rounded btn-icon btn-xs valign-text-bottom" onclick="return confirm('Are you sure to Deactivate this record?')"><i class='icon-unlocked'></i></a>
                      @else
                        <a href="{{ $module_url_path.'/activate/'.base64_encode($data['city_id']) }}" class="btn border-warning-400 text-warning-400 btn-flat btn-rounded btn-icon btn-xs valign-text-bottom" onclick="return confirm('Are you sure to Activate this record?')"><i class=' icon-lock'></i></a>
                      @endif
                    ...
                    <td> 
                          ...
                          <a href="{{ $module_url_path.'/edit/'.base64_encode($data['city_id']) }}" class="call_loader btn border-teal text-teal btn-flat btn-rounded btn-icon btn-xs valign-text-bottom">
                        ...
                        <a href="{{ $module_url_path.'/delete/'.base64_encode($data['city_id'])}}"  
                        onclick="return confirm_delete();" class="call_loader btn border-warning-400 text-warning-400 btn-flat btn-rounded btn-icon btn-xs valign-text-bottom" style="    margin-left: 10px;">
