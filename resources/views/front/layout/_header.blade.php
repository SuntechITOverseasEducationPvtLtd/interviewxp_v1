...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <!-- main CSS -->
       <link href="{{url('/')}}/css/front/bootstrap-toggle.css" rel="stylesheet" type="text/css" />
      ...
      <script type="text/javascript" language="javascript" src="{{url('/')}}/js/front/bootstrap.min.js"></script>
        <script type="text/javascript" language="javascript" src="{{url('/')}}/js/front/bootstrap-toggle.js"></script>
...
<style>  
.img-zoom{height:100%; width:100%; background-size:cover; background-position:center; transition: all 0.5s ease;}
.img-zoom:hover{transform: scale(1.2);}


.sheader_01{background-color: rgba(0 ,0 ,0 , 0.75);}
.sheader_02{padding-left: 10px;}
.sheader_03{margin-top: 16px;color:#fff; font-size: 24px;}
.sheader_04{font-size: 22px}
.sheader_05{float: right;margin: 0px 27px 0px -27px;}
.sheader_06{display:none}
.sheader_07{height: 33px;}
.sheader_08{width:100%}
.text-center{text-align:center}
   ...
   <body class="">
      ...
      <div id="member-header" class="after-login">
         <div class="header sheader_01" >
            <div class="container-fluid sheader_02" >
               <div class="row ">
                  <div class="col-xs-6 col-sm-2 col-md-2 col-lg-3">
                     ...
                     <div class="col-sm-2">
                       <a id="menu-toggle" href="#"><span id="main_icon" class="fa fa-align-justify fa-2x sheader_03" ></span></a>
                     </div>
                  </div>
                  <div class="col-xs-6 col-sm-7 col-md-5 col-lg-4 swap-right">
                     <div class="text-right menu-right right-menu p-t-0">
                        ...
                        {{-- <a href="{{url('/member/post_interview')}}" class="member-profile-btn hidden-xs">Post an Interview Q &amp; A</a> --}}
                           ...
                           <a href="{{url('/member/post_interview')}}" class="member-profile-btn hidden-xs"><i class="fa fa-pencil-square-o sheader_04" aria-hidden="true" ></i>
                           <span class="sheader_05">Create New</span></a>
                              ...
                              <div class="dropdown-wrapper n-top">
                                 <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                       <li><a href="{{url('/member/revenue_history')}}"><i class="fa fa-file-text-o" aria-hidden="true"></i> Revenue Reports</a></li>
                                       <li><a 
                                          href="{{url('/member/edit_employment')}}"><i class="fa fa-user" aria-hidden="true"></i> My Profile</a></li>
                                        <li><a 
                                          href="{{url('/member/manage_upload_history')}}"><i class="fa fa-upload" aria-hidden="true"></i> Manage Uploads</a></li>  
                                         <li><a 
                                       ...
                                       <li class="sheader_06" style="display:none"><a href="{{url('/member/create_alert')}}"><i class="fa fa-bell-o" aria-hidden="true"></i> Alerts</a></li>
                                        <li><a href="{{url('/member/mlearnlist')}}"><i class="fa fa-bell-o" aria-hidden="true"></i> Wishlist</a></li>
                                       <li><a 
                   ...
                   <!--<div class="col-xs-2 col-sm-2 hidden-md hidden-lg pad-remove"><button class="click-search"><i class="fa fa-search"></i></button></div>-->
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5 pad-remove swap-left text-center">
                         <div class="input-box s-input-box">
							<form method="GET" name="frm_search" action="{{url('/')}}/searchskill">
								<input placeholder="Type Your Skill,Location,Experience,Coach Name..." type="text" name="search" id="skill_name" class="sheader_07" />
				...
				{{--<div class="col-xs-12 col-sm-12 col-md-4 col-lg-5 pad-remove swap-left text-right" >
                     <div class="input-box s-input-box">
                        <form method="get" name="frm_search" action="{{url('/')}}/searchskill">
                          {{ csrf_field() }}
...
@elseif(Session::has('logged_in') && Session::get('logged_in')=='user' && $obj_user!=false && !$obj_user->inRole('admin'))
      ...
      <div id="after-login-header" class="after-login">
         <div class="header sheader_01">
            <div class="container sheader_08" >
               <div class="row ">
                  ...
                  <div class="col-xs-6 col-sm-4 col-md-3 col-lg-4 swap-right" >
                                 ...
                                 <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                       ...
                                       <li><a href="{{url('/user/purchase_history')}}"><i class="fa fa-history" aria-hidden="true"></i> Purchase History</a></li>
                                        ...
                                        <li class="sheader_06" style="display:none"><a href="{{url('/user/create_alert')}}"><i class="fa fa-bell-o" aria-hidden="true"></i> Alerts</a></li>
                                        
                                        
                                       <li><a href="{{url('/user/learnlist')}}"><i class="fa fa-bell-o" aria-hidden="true"></i> Wishlist</a></li>
                   ...
                   <!--<div class="col-xs-3 col-sm-4 hidden-md hidden-lg"><button class="click-search"><i class="fa fa-search"></i></button></div>-->
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 pad-remove swap-left text-center">
                         <div class="input-box s-input-box">
							<form method="GET" name="frm_search" action="{{url('/')}}/searchskill">
								<input placeholder="Type Your Skill,Location,Experience,Coach Name..." type="text" name="search" id="skill_name" class="sheader_07" />
								<div class="error" id="err_search"></div>
               ...
               <div class="row ">
                  ...
                  <!--search bar start here-->
                   <div class="col-xs-5 col-sm-7 hidden-md hidden-lg"><button class="click-search"><i class="fa fa-search"></i></button></div>
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 pad-remove text-center" >
                         <div class="input-box s-input-box">
							<form method="GET" name="frm_search" action="{{url('/')}}/searchskill">
								<input placeholder="Type Your Skill,Location,Experience,Coach Name..." type="text" name="search" id="skill_name" class="sheader_07"/>
								<div class="error" id="err_search"></div>
