...
-->
   ...
   @if(isset($arr_user_info[0]['training_tab']))
   <li @if(\Request::segment(2)=='schedule_class' || \Request::segment(2)=='class_enrollments' ||\Request::segment(2)=='curriculam') class='has-sub active' @else class='has-sub active' @endif >
      <a href='javascript:void(0)'>
        <span>Training Classes</span>
      </a>

      <ul class="submenu" @if(\Request::segment(2)=='schedule_class' || \Request::segment(2)=='class_enrollments' ||\Request::segment(2)=='curriculam') style="display: block;" @endif>
