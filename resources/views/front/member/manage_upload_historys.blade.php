													   ...
													   <div class="sub-tab">
														  <div class="ref-book" style="width: 100%;">
																...
																<span class="addTopicMain" style="background-color: #17b0a4;color:#fff;border: 1px solid #17b0a4;padding:5px;">
																	<i class="fa fa-plus" aria-hidden="true"></i><span style="color:#fff;     font-family: ubuntumedium;
    font-size: 16px;">Add Topic</span>
																 </span>												
															...
															<button class="submit-btn  ctn saveBookBtn" attrId="{{$uploads['id']}}" style="border: none;border-radius:0px;height: 39px;margin-top:10px;width:114px;">Save</button>				<a href="javascript:;" class="cancelBookBtn cancel-btn" attrId="{{$uploads['id']}}" style="border: none;border-radius:0px;height: 39px;margin-top:10px;width:100px;margin-right: 20px; padding-top: 10px;
       padding-bottom: 11px;">Cancel</a>
																 ...
																 <table class="table table-striped" id="interviewqalist">
																	...
																	<tbody id="interview-qa-list">
																	   ...
																	   <?php
																		...
																		//print_r(count($new_approvals));					
																		//print_r($reference_book_details);			
																	   ?>
