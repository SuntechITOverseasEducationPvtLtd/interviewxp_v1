<style>
    .shome_blade_01{padding-right: 0px;}
.shome_blade_02{text-align: center; color: red; font-size: 16px;}
</style>
                     ...
                     <div class="row box-right">
                        <div class="col-sm-10 col-md-10 col-lg-10">
						   ...
						   <?php 
							...
							?>
                           <ul class="shome_blade_01">
                              <li class="shome_blade_01">
         ...
         <div class="box">
            <div class="row">
                 <div class="col-sm-12 col-md-12 col-lg-12">
                     <div class="shome_blade_02">Sorry no records found!!</div>
                  </div>
            </div>      
         </div>
      @endif
