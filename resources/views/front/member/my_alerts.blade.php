                     ...
                     <nav>
                        <ul>
                           <li class="">
                             ...
                             <a href="{{url('/member/create_alert')}}">Create Alerts</a>
                           </li>
                           <li class="active">
                              <!-- <a href="#doctor2">My Saved Alerts</a> -->
                              <a href="{{url('/member/manage_alert')}}">My Saved Alerts</a>
                           </li>
                        </ul>
                     </nav>
                     <div class="content">
                        ...
                        @include('admin.layout._operation_status')  
                         <form id="frm_manage" action="{{url('/member/multi_action')}}" id="frm_alerts_manage" method="POST" enctype="multipart/form-data" data-parsley-validate> 
                            {{ csrf_field() }}
                           <div class="icon-wrapper"> 
                              ...
                              <a href="{{url('/member/manage_alert')}}" class="refresh-i"><i class="fa fa-refresh" aria-hidden="true"></i></a>
                           </div>
                                    ...
                                    <tbody>
                                      ...
                                      <?php $i = 1; ?>
                                       ...
                                       <tr class="strips">
                                          ...
                                          <td>
                                             <div class="text-left">
                                                <a href="{{url('/')}}/member/view_alert/{{ base64_encode($data['alert_id']) }}" class="eye-i"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                <a href="{{url('/')}}/member/edit_alert/{{ base64_encode($data['alert_id']) }}" class="edit-i"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                <a href="{{url('/')}}/member/delete_alert/{{ base64_encode($data['alert_id']) }}" onclick="return confirm('Are you sure to Delete this record?')" class="delete-i"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                             </div>
                                          </td>
                                       </tr>
                                      @endforeach
                                       @else
                                       <tr><td colspan="6"><div style="color:red;text-align:center;">Alert data not available </div></td></tr>
                                       @endif
                                    </tbody>
                                 </table>
                              </div>
