...
<div class="container-fluid fix-left-bar">
   <div class="row">
      ...
      <div class="col-sm-9 col-md-9 col-lg-10 extra-height">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-8">
                                                   <div class="user-box">
                                                     ...
                                                     <!--  <input id="video" style="visibility:hidden; height: 0;" name="videofile" type="file" onchange="chk_video()">
                                                      ...
                                                      <input id="videoUrl" type="text" name="videofile" class="input-box-signup" data-parsley-pattern="/^(?:https?:\/\/)?(?:www\.)?youtube\.com\/watch\?(?=.*v=((\w|-){11}))(?:\S+)?$/" data-parsley-pattern-message="Please Enter Valid Youtube Url." data-parsley-errors-container="#error_url" >
