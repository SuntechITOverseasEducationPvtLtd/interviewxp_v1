    ...
    @include('front.layout._operation_status')
        <div class="search-detail-topSection">
            ...
            <ul class="first-list">
                ...
                <li style="margin-left: 28%"><i class="fa fa-phone" aria-hidden="true"></i><b>&nbsp;&nbsp;&nbsp;+91-40-64648700, 9000539774</b></li>
                <li><i class="fa fa-envelope" aria-hidden="true"></i></i><b>&nbsp;&nbsp;&nbsp;support@interviewxp.com</b></li>                
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2 col-md-1 col-lg-1">
                                                <div class="user-bl user-review-icon">
                                                    <!--<img src="{{$user_profile_public_img_path}}{{$profile_image}}" class="img-responsive" alt="Interviewxp" />-->
