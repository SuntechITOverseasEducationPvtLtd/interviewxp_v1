...
"></i> Upload Image
 ...
 <p style="width:100%; margin:5px 0px ; display:none" id="skillidshow1"><select id="skill_id1" name="skills[]"  > </select></p>
 <p style="width:100%; margin:5px 0px ; display:none" id="skillidshow2"><select id="skill_id2" name="skills[]"  > </select></p>
 <p style="width:100%; margin:5px 0px ; display:none" id="skillidshow3"><select id="skill_id3" name="skills[]"  > </select></p>
 <p style="width:100%; margin:5px 0px ; display:none" id="skillidshow4"><select id="skill_id4" name="skills[]"  > </select></p>
 <p style="width:100%; margin:5px 0px ; display:none" id="skillidshow5"><select id="skill_id5" name="skills[]"  > </select></p>
                                                ...
                                                <p class="addmoreskill" id="1" ><i class="fa fa-plus-square" aria-hidden="true"></i> More Skill</p>
                                             </div>
                                          </div>
                                       </div>
               ...
               <div class="outer-box history-page">
                  ...
                  <div class="table-responsive">
                     <table class="table">
                        ...
                        if(($uploads['video']!="") && isset($uploads['video'])) { $disblk="block"; 
                        $videoID=explode('?v=',$uploads['video']);
                        
                        } else{  $disblk="none";  } ?>
                        
                        
                        
                        @if( ($uploads['image']!="") && ($uploads['image']!=null) )
                       
    <div class="video" style="background-image:url('http://cloudforcehub.com/interviewxp/uploads/interview_images/{{$uploads['image']}}')">
        
  <a data-toggle="modal" href="#videoplayintro" class="videoidtake" id="{{$videoID[1]}}" style="text-align: center;"> 
  
  <img src="{{url('/')}}/images/icon-play.svg" class="img-zoom"  style="display:{{$disblk}};     float: none;"></a>
    
    </div>
                        @elseif(($uploads['video']!="") && ($uploads['video']!=null) && ($videoID[1]!=""))
  ...
  <img src="{{url('/')}}/images/icon-play.svg" class="img-zoom"  style="display:{{$disblk}};     float: none;"></a>
     ...
     @else
             <div class="video" style="background-image:url('{{url('/')}}/uploads/no-image.png')">
...
var urlnew = "{{ url('/get_skills') }}";  
   ...
   $('#skill_id1').tokenize(
    	...
    	$(document).on('click', '.addmoreskill', function() {			
				
 $ids=$(this).attr('id');
 
 
$("#skillidshow"+$ids).css('display','block');
 $idsf=parseInt($ids)+1;
		 $(this).attr("id", $idsf);	
   ...
   //<!--file upload js script for upload video start-->  
         ...
         function removeBrowsedfile() {
			 ...
			 $('#experience').change(function() {
				 ...
				 var skilln = $('#skill_id').val();
				 var skill1 = $('#skill_id1').val();
				 var skill2 = $('#skill_id2').val();
				 var skill3 = $('#skill_id3').val();
				 var skill4 = $('#skill_id4').val();
				 var skill5 = $('#skill_id5').val();
				
				 if(typeof(skill1) != "undefined" && skill1 !== null) { var skill1n=','+skill1; } else {var skill1n=""; } 
			if(typeof(skill2) != "undefined" && skill2 !== null) { var skill2n=','+skill2; }  else {var skill2n=""; }
		if(typeof(skill3) != "undefined" && skill3 !== null) { var skill3n=','+skill3; } else {var skill3n=""; } 
			if(typeof(skill4) != "undefined" && skill4 !== null) { var skill4n=','+skill4; }  else {var skill4n=""; } 
				 if(typeof(skill5) != "undefined" && skill5 !== null) { var skill5n=','+skill5; } else {var skill5n=""; }
				 
				var skill = skilln+skill1n+skill2n+skill3n+skill4n+skill5n; 
				 var value = $(this).val();
				 var html = '';
...
<div class="modal fade popup-cls in" id="youtubevideoup" role="dialog" aria-hidden="false">
  ...
  <div id="uploadimageModal" class="modal" role="dialog" style="margin-top: -253.5px !important;">
    ...
    line-height: 45px; } 
    div.Tokenize ul li span {  font-size: 14px !important;}
...
.addmoreskill {float: left;
    width: 100%;
    text-align: right;
    padding-right: 15px;
    font-size: 13px;
    padding-top: 7px;
    color: #17b0a4;     cursor: pointer; }
		</style>
