						...
						<nav>
							<div class="container">
								<ul class="options" style="border-bottom:none;">
									...
									<li>
										<a href="#tab3RealTime1">Real Time Issues <br>(Tickets, Tasks, Etc.,)</a>
									</li>
									@endif
									...
									<div class="content">
										<section id="tabTextResume" style="display: block;">
											<div class="col-md-12">
												...
												?>													
													<label for="radio_textresume" class="member-profile-btn check-box referencebook_textResume" style="margin-bottom:15px; cursor:pointer">
