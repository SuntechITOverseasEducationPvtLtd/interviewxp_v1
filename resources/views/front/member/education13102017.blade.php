                ...
                <?php $current_year = date('Y'); ?>
                  ...
                  <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group">
                           <label>
                              City Name<span class="star">*</span>
                           </label>
                           <input id="other_city" type="text" class="input-box-signup"  name="other_city" placeholder="Enter your city name here"  value="{{ old('city_name') }}" data-parsley-required="true" data-parsley-errors-container="#err_city_name" data-parsley-required-message="This field is required"/>
                            <div id="err_city_name" class="error"></div>
                        </div>
...
<script type="text/javascript">
   $(document).ready(function(){
        var value_employer_type = $("input[name='employer_type']:checked").val();
        if(value_employer_type=='current')
        {
          $('#employer_value').attr('data-parsley-required', 'false');
        }
        else
        {  
          $('#employer_value').attr('data-parsley-required', 'true');
        }
