		...
		<div class="appom-box search-detail-tabs" style="padding-top: 10px !important;">
			<div class="box-m">
				<div class="tab-contact">
					...
					<nav>
						<div class="container">
						  <div class="scroller scroller-left"><i class="fa fa-chevron-circle-left" style="color: #17b0a4;font-size: 25px;"></i></div>
						  <div class="scroller scroller-right"><i class="fa fa-chevron-circle-right" style="color: #17b0a4;font-size: 25px;"></i></div>
						  <div class="wrapper">
						    <ul class="options nav nav-tabs list tabs-header" style="border-bottom:none;" role="tablist" id="myTab">
						       <li role="presentation" class="box tab-box active" id="interview-coach" onclick="showBoxTab('tabTextResume');">
									<a href="#tabTextResume"><b>Interview Coaching</b></a>
									...
									?>		<input class="css-checkbox ads_Checkbox" value="{{$arr_price_list['validity']}}" id="radio_textresume" name="reference_book_textResume" type="checkbox">
											...
											<i class="fa fa-inr" style="width: 90%;"><span class="tab-price">{{ number_format($arr_price_list['validity'], 0, '', '')}}</span></i>
							  ...
							  @if($arr_interview['admin_approval_qa']==1)
								<li role="presentation" class="box tab-box" id="interview-qa" onclick="showBoxTab('tab1InterView');">
									<a href="#tab1InterView"><b>Interview Q &amp; A</b>  </a>
								...
								<li role="presentation" class="box tab-box " id="interview-company" onclick="showBoxTab('tab2Company');">
									<a href="#tab2Company"><b>Interviews By Companies</b></a>
									<div class="check-box">
								...
								<li role="presentation" class="box tab-box realissues" id="interview-realissues" onclick="showBoxTab('tab3RealTime1');">
									<a href="#tab3RealTime1"><b>Real Time Work Experience</b><!-- <br>(Tickets, Tasks, Etc.,) --></a>
								...
								<li role="presentation" class="box tab-box" id="combo-coach-interview-qa">
									...
									<div class="check-box">
										...
										<i class="fa fa-inr" style="color: #ccc;margin: 0px -10px 0px -10px;text-decoration: line-through;"><span class="tab-price" style="font-size: 20px">{{ number_format($arr_price_list['ref_book_price']+$arr_price_list['validity'], 0, '', '')}}</span></i>
								...
								<li role="presentation" class="box tab-box" id="combo-coach-company">
									<a href="#"><b>Coaching & 2 Companies</b></a>
									<div class="check-box">
										...
										<i class="fa fa-inr" style="color: #ccc;margin: 0px -10px 0px -10px;text-decoration: line-through;"><span class="tab-price" style="font-size: 20px">{{ number_format((2*$arr_price_list['interview_price'])+$arr_price_list['validity'], 0, '', '')}}</span></i>
								...
								<li role="presentation" class="box tab-box" id="combo-coach-realissues">
									<a href="#"><b>Coaching & Work Exp-50</b></a>
									<div class="check-box">
										...
										<i class="fa fa-inr" style="color: #ccc;margin: 0px -10px 0px -10px;text-decoration: line-through;"><span class="tab-price" style="font-size: 20px">{{ number_format($arr_price_list['price_for_50_ticket']+$arr_price_list['validity'], 0, '', '')}}</span></i>
						...
						<?php */ ?>
						<div class="container nav-tab-content" style="clear: both">
							<div class="row">
								<div class="col-md-12">
									<div class="content">
																...
																<?php
																   ...
																   $results = DB::select( DB::raw("SELECT * FROM interview_detail WHERE interview_id = '".$interviewid->interview_id."' AND approve_status='1' group by company_id") );
																	foreach ($results as $key=>$user) {
																		...
																		<li style="border:1px solid #eee; line-height:35px; padding-left:20px; padding-right:20px;" title="{{$user->topic_name}}"><input  class="css-checkbox ads_Checkbox interview_company_checkbox"  value="1"  id="radio_{{$user->company_id}}" name="company[{{$user->company_id}}]" type="checkbox"><label class="css-label radGroup2" for="radio_{{$user->company_id}}"></label><b> {{$NameC}} ({{$user->company_location}}) </b> <img src="../images/down-arow.png" class="downArrow" style="float: right; cursor:pointer;margin-top:10px;">
...
{       
    ...
    function validation()
    {
        ...
        {
        	var selectedCompanies = $("input:checkbox[name^='company']:checked").length;
        	if(selectedCompanies<2)
        	{
        		 $('#error_validation_msg').html('Please select 2 companies.');
            	 return false;	
        	}
        }
