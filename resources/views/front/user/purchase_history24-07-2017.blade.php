                                          ...
                                          <thead class="strips">
											 ...
											 <table>
												...
												@if(isset($data['purchase_history'][0]['training_schedule_id']))
												   ...
												   <td>* Training</td>
												   <td>
													   <i class="fa fa-eye" title="" style="cursor:pointer" aria-hidden="true"></i>
												   </td>
												   <td>
														<div class="star-wrapper">
															<div class="starrr">
																<input class="star" type="radio"  name="training_review_star_{{$data['purchase_history'][0]['training_schedule_id']}}_{{$key}}" value="1" title="I hate it" />
																<input class="star" type="radio" name="training_review_star_{{$data['purchase_history'][0]['training_schedule_id']}}_{{$key}}" value="2" title="I dont like it" />
																<input class="star" type="radio" name="training_review_star_{{$data['purchase_history'][0]['training_schedule_id']}}_{{$key}}" value="3" title="Its Okey" />
																<input class="star" type="radio" name="training_review_star_{{$data['purchase_history'][0]['training_schedule_id']}}_{{$key}}" value="4" title="I like it" />
																<input class="star" type="radio" name="training_review_star_{{$data['purchase_history'][0]['training_schedule_id']}}_{{$key}}" value="5" title="I love it" />
															</div>
															<div class="clearfix"></div>
															<div class="error">{{ $errors->first('review_star') }}</div>
														</div>
													</td>
													<td><span class="writeReview" dataValue="Training" dataTitle="Training" id="" style="border:1px solid #17b0a4;padding:6px;display:block;cursor:pointer;">Write a review</span></td>
                                                 @endif
                                                </tr>
												 </tr>
