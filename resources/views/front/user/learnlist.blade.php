...
?>
     ...
     <div class="container lcl1">
      ...
      <div class="row top-strip-table lcl2" >
          <div class="col-lg-1" ><div class="lcl3">SN</div> <div class="lcl4">Date</div></div>
       
       <div class="col-lg-10">
            <div class="lcl3">Description</div> 
       
       </div>
       
         <div class="col-lg-1">
             <div class="lcl4">Action</div>
      ...
      @if(isset($arr_interview) && sizeof($arr_interview)>0)
         ...
         <div class="row lcl5" >
                   ...
                   <div class="col-lg-1" class="lcl6" ><div class="lcl3"><?=$sins;?></div> <div class="lcl7" ><?php $dates=explode(" ",$interview['created_at']); 
       ...
       <div class="col-lg-10">
            <div class="box">
               <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-3 lcl8" >
                     <div class="box-left">
                        ...
                        @else
                        <img src="{{url('/')}}/uploads/no-image.png" alt="Interviewxp" class="img-responsive lcl9" />
                        @endif
                        </a>
                     </div>
                  </div>
                  <div class="col-sm-12 col-md-12 col-lg-9 mar-left-px lcl10" >
 ...
 @endif 
    ...
    color: #fc575c;
    padding-top: 53px;
    cursor: pointer;"><a href="{{url('/').'/user/deletelearnlist/'.base64_encode($interview['ids']) }}" onclick="return confirm_delete();">
...
.lcl1 {width:100%; background: #fafafa6b; min-height: 500px; }
.lcl2 {padding-top: 10px;
    margin-top: 20px;
    height: 40px;
    text-align: center;
    /* font-weight: bold; */
...
.lcl3 {float:left;}
.lcl4 {float:right;}
.lcl5 {padding-top: 5px;}
.lcl6 {padding-top: 59px;}
.lcl7 {float:right;     color: #15a49d;}
.lcl8 {padding-right: 0px;    margin-right: 0px; }
.lcl9 {width: 100%;
    margin-left: 5px;}
.lcl10 {padding-left: 0px;    margin-left: 0px; }
