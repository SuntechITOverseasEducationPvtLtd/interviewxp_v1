                                             ...
                                             <tr class="sub-content" style="display:none;">
                                               ...
                                               @if($data['reference_book'] == "Yes")
                                                   <p>
                                                      ...
                                                      <a href="{{url('/')}}/user/view_learn/{{ base64_encode($data['id']) }}/referencebook"><span> Interview Refference Book (30 Days Validity)</span>
                                                 ...
                                                 @if($data['interview_count_arr']!=0)
                                                   <p>
                                                      <i class="fa fa-check" aria-hidden="true"></i>
                                                       <a href="{{url('/')}}/user/view_learn/{{ base64_encode($data['id'])}}/company">
                                                 ...
                                                 @if($data['purchase_history'][0]['ticket_name']!="")
                                                   <p>
                                                      <i class="fa fa-check" aria-hidden="true"></i>
                                                       <a href="{{url('/')}}/user/view_learn/{{ base64_encode($data['id'])}}/rwe_tickets">
