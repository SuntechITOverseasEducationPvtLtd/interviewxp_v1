...
<div class="banner-change-pw">
      ...
      <div class="middle-area min-height">
           ...
           <form id="frm_manage" action="{{url('/user/multi_action_notification')}}" id="frm_alerts_manage" method="POST" enctype="multipart/form-data" data-parsley-validate> 
           {{ csrf_field() }}
         <div class="container">
         ...
         @if(isset($arr_notification['data']) && sizeof($arr_notification['data'])>0)
          ...
          <div class="notification-box notify">
           <div class="row">
               ...
               <a href="{{url('/user/delete_notification/'.base64_encode($notification['id']))}}" onclick="return confirm('Are you sure to Delete this notification?')" class="delete-i"><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
               </div>
               </div>
           </div>
          </div>
