   ...
   <div class="banner-change-pw">
         <div class="pattern-change-pw">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="heading-changepw">Purchase History</div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="container max-height">
                                       ...
                                       <table class="table">
                                          ...
                                          <thead>
                                             <tr class="top-strip-table">
                                                <td style="width:15px; margin: 0px;
        padding: 8px 0px 6px 8px;">
                                                ...
                                                <td style="width:20px; margin: 0px;
    padding: 8px 0px;">S.No.</td>
                                                <td style="text-align: left;     padding-left: 9px;">Description</td>
                                                <td>Exp.Level</td>
                                                <td>Purchased date</td>
                                                <!-- <td>Validity Date</td> -->
                                                <td>Amount</td>
                                                <td colspan="2" style="padding-left: 0px;">View</td>
                                             </tr>
                                          </thead>
                                         <tbody class="strips">
                                         ...
                                         @foreach($purchase_history as $key=>$data)
                                          <?php if($key%2==0) { $baclass="asgray"; }  else {  $baclass="aswhite"; } ?>
                                             <tr class="main-content {{$baclass}}">
                                                <td style="border-bottom: 1px solid #f1f1f1  !important; width:15px; margin: 0px;
       padding: 8px 0px 6px 8px;">
                                                   <div class="check-box-UserAlert">
                                                ...
                                                <td style="border-bottom: 1px solid #f1f1f1  !important; width:20px; margin: 0px;
    padding: 8px 0px;">{{$key+1}}</td>
                                                <td style="text-align: left; border-bottom: 1px solid #f1f1f1  !important;">{{$data['skill_name'] or 'NA'}}</td>
                                                <td style="border-bottom: 1px solid #f1f1f1  !important;">{{$data['experience_level'] != 'NA' ? $data['experience_level'].' Years' : 'NA'}}</td>
                                                <td style="border-bottom: 1px solid #f1f1f1  !important;">{{date('d M Y', strtotime($data['created_at']))}}</td>
                                                
                                                <td style="border-bottom: 1px solid #f1f1f1  !important;">Rs.{{ $data['grand_total'] or 'NA' }}</td>
                                                <td style="border-bottom: 1px solid #f1f1f1  !important;">
                                                ...
                                                <td class="arrow"style="border-bottom: 1px solid #f1f1f1  !important;"  rel="sub-content-{{$key}}"><i class="fa fa-chevron-down" aria-hidden="true"></i></td>
                                             </tr>
                                             <?php
                                             ...
                                             <?php if($item%2==0) { $baclasss="asgreen"; }  else {  $baclasss="aswhite"; } ?>
                                             	<tr class="sub-content {{$baclasss}} sub-content-{{$key}}" style="display:none;">
                                             		<td colspan="2" style="border-bottom: 1px solid #f1f1f1  !important;"></td> 	
										  		 	<td style="   text-align: left;
    padding-top: 5px;
    border-bottom: 1px solid #f1f1f1 !important;
    padding-bottom: 0px;">@if($transactionItem->combo_status == 1 && $item == 0 && ($transactionItem->combo_type == '5 Companies' || $transactionItem->combo_type == '10 Companies' || $transactionItem->combo_type == '20 Companies'))<span style="color: #FF8000;padding-left: 7px;width: 32%;">{{$transactionItem->combo_type}}</span>@elseif($transactionItem->combo_status == 1 && $item == 0)<span style="color: #FF8000;padding-left: 7px;width: 32%;">Combo</span>@endif <br>{!!$description!!}</td>
										   			<td style="border-bottom: 1px solid #f1f1f1  !important;">@if(isset($transactionItem->review_star))<img src="{{url('/')}}/images/review.png" title="{{$tit}}" style="width: 19px;    cursor: pointer;"/>@endif</td>
                                             		<td style="border-bottom: 1px solid #f1f1f1  !important;">
													...
													<td style="border-bottom: 1px solid #f1f1f1  !important;">@if(empty($transactionItem->review_star))<span class="writeReview" dataValue="Interview Coaching" dataClass="{{$class}}_review_form_{{$key}}" dataTitle="Interview Coaching" id="" style="border:1px solid #17b0a4;padding:6px;display:block; cursor:pointer; {{$css}}">Write a review</span>@endif</td>
                                         	   		<td colspan="2" style="border-bottom: 1px solid #f1f1f1  !important;"></td>
                                             	</tr>
                                             	<tr class="{{$class}}_review_form_{{$key}}"  style="display:none; background-color: rgb(255, 255, 255);">
	                                            	<td>
	                                            	...
	                                            	<td colspan="2">
	                                            		<button type="reset" class="btn btn-primary close-review cancel-btn" dataClass="{{$class}}_review_form_{{$key}}">Cancel</button>
	                                            		</form>
	                                        		</td>
	                                            </tr>
