...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <?php $usertamlate = DB::table('tbl_emailtemplate') ->where(['mailcategory'=>6])->where(['is_active'=>1])->get();		?>
            ...
            <td bgcolor="#FFFFFF" style="border:1px solid #e5e5e5;">
               <table style="margin-bottom: 0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                     ...
                     <?php /* isset($arr_built_content['FIRST_NAME'])?$arr_built_content['FIRST_NAME']:'Sir/Mam' */ ?>
                     
                     
                   <?php
                   
                   $name=$arr_built_content['FIRST_NAME'];
                   $lname="";
                   $emails="";
                   $emails="";
                   $user_name="";
               ...
               <tr>
                  ...
                  <td class="listed-btn" style="text-align:center">
