...
class SubCategoryController extends Controller
{
                                ...
                                ActivityLogsModel $activity_logs)
    {
         ...
         $this->BaseModel =  $subcategory;
        $this->ActivityLogsModel     = $activity_logs;
        
        $this->arr_view_data        = [];
        $this->admin_url_path       = url(config('app.project.admin_panel_slug'));
        $this->module_url_path      = $this->admin_url_path."/subcategories";
        $this->module_view_folder   = "admin.subcategories";

        $this->module_title = "Subcategory";
        /*For Activity log*/
    ...
    {
        $arr_subcategory = [];
        $obj_subcategory = $this->BaseModel->with(['category'])->get();
        if($obj_subcategory)
        {
            $arr_subcategory = $obj_subcategory->toArray();
        }
        
        $this->arr_view_data['arr_data']        = $arr_subcategory;
    ...
    public function store(Request $request)
    {
        ...
        $does_exists = $this->BaseModel
                            ...
                            ->where('subcategory_name','=',trim($request->input('subcategory_name')))
                            ->count();   
        if($does_exists)
        {
        ...
        $arr_user_data['subcategory_name'] = $request->input('subcategory_name');
    ...
    public function edit($enc_id)
    {
        ...
        $arr_subcategory = [];
        $obj_subcategory = $this->BaseModel->where('id',$id)->first();
        if($obj_subcategory)
        {
            $arr_subcategory = $obj_subcategory->toArray();
        }
    ...
    public function update(Request $request)
    {
        ...
        $does_exists = $this->BaseModel
                            ->where('id','<>',$id)    
                            ->where('subcategory_name','=',$request->input('subcategory_name'))
                            ->count();   
        if($does_exists)
        {
            Flash::error(str_singular($this->module_title).' Already Exists!!!');
