...
class PaymentController extends Controller
{
    ...
    public function order_summery(Request $request)
    {
       ...
       // {
        ...
        //}
        $sub_total                                    = $TextResume_boxAmount+$total_interview_amount+$reference_book_bought+$total_ticket_amount;
    ...
    public function pay_now(Request $request)
    {
      ...
      {  
          ...
          if($company_count==0)
          {
			  ...
			  $arr_purchase['InterviewByCompaniesID']   = "1";
    ...
    public function purchased_tickets(Request $request)
    {
        ...
        $arr_data     = $request->input('arr_data');
