...
*/
   ...
   */
   ...
   public function purchase_history_old()
   {
        ...
        $user_id = $this->user_id;
         $obj_transaction= $this->TransactionModel
                                 ->with(['purchase_history','member_detail','user_detail','member_interview_info',
       ...
       if(isset($arr_transaction['data']) && sizeof($arr_transaction['data'])>0)
       {
        foreach($arr_transaction['data'] as $key => $details) 
      	{	 
            //print_r($details['purchase_history']);
     ...
     public function view_learn($enc_id,$type)
   {
        ...
        //print_r($arr_transaction['purchase_history']); 
        //die;
