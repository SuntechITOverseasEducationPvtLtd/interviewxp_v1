	...
	Route::group(['prefix' => $admin_path,'middleware'=>['admin']], function () 
	{
		...
		----------------------------------------------------------------------------------------*/
			...
			Route::group(array('prefix' => '/admin_users'), function()
			{
				...
				Route::group(array('prefix' => '/users_roles'), function()
			{
				$route_slug       = "users_roles_";
				$module_controller = "Admin\UserroleController@";
		...
		----------------------------------------------------------------------------------------*/
			...
			Route::any('edit_employment/{enc_id}/{user_id}',			['as' => $route_slug.'edit',		 'uses' => $module_controller.'edit_employment']);
				Route::get('education/{mem_id}',			['as' => $route_slug.'create','uses' => $module_controller.'education']);
				Route::get('edit_education/{mem_id}/{user_id}',			['as' => $route_slug.'edit',		 'uses' => $module_controller.'edit_education']);
				Route::post('store/',			['as' => $route_slug.'store',		 'uses' => $module_controller.'store']);
				...
				Route::get('all-coaches',			['as' => $route_slug.'allCoaches',		 'uses' => $module_controller.'allCoaches']);
				Route::get('coach-notifications',			['as' => $route_slug.'coachNotifications',		 'uses' => $module_controller.'coachNotifications']);
				Route::get('coach-bookings/{member_id}',			['as' => $route_slug.'memberCoachBookings',		 'uses' => $module_controller.'memberCoachBookings']);
               Route::get('all-members',			['as' => $route_slug.'allMembers',		 'uses' => $module_controller.'allMembers']);
				Route::get('member-sales/{member_id}',			['as' => $route_slug.'memberSales',		 'uses' => $module_controller.'memberSales']);
				...
				Route::get('booking_profile/{enc_id}',			['as' => $route_slug.'booking_profile',		 'uses' => $module_controller.'booking_profile']);
				
				Route::get('interviewqa_profile/{enc_id}',			['as' => $route_slug.'interviewqa_profile',		 'uses' => $module_controller.'interviewqa_profile']);
		...
		----------------------------------------------------------------------------------------*/
			...
			{	
				...
				Route::get('/sales/{from}/{to}',					['as' => $route_slug.'sales',		 'uses' => $module_controller.'sales']);
				Route::get('/total-sales',					['as' => $route_slug.'total-sales',		 'uses' => $module_controller.'totalSales']);
				Route::get('/details/{enc_id}',					['as' => $route_slug.'details',		 'uses' => $module_controller.'view_transaction_detail']);
				Route::get('/payments/{from}/{to}',					['as' => $route_slug.'payments',		 'uses' => $module_controller.'member_payments']);
				Route::get('/member-payments/{user_id}/{fromdate}/{todate}',					['as' => $route_slug.'member-payments',		 'uses' => $module_controller.'total_member_payments']);
				Route::post('/refund-payments',					['as' => $route_slug.'refund-payments',		 'uses' => $module_controller.'refundPayment']);
				Route::post('/pay-member-payment',					['as' => $route_slug.'pay-member-payment',		 'uses' => $module_controller.'payMemberPayment']);

				Route::get('/total-payments',					['as' => $route_slug.'total-payments',		 'uses' => $module_controller.'totalPayments']);
...
Route::group(array('prefix'=>'/review_rating'), function () 
			{
				...
				Route::get('/',['as' => $route_slug.'index',
								'uses' => $route_controller.'index']);
				Route::get('/index_old',['as' => $route_slug.'index_old',
								'uses' => $route_controller.'index_old']);
				Route::get('/member-reviews-ratings/{member_id}',['as' => $route_slug.'memberReviewsRatings',
								'uses' => $route_controller.'memberReviewsRatings']);
			...
			Route::group(array('prefix'=>'/career'), function () 
			{
				...
				Route::get('/',['as' => $route_slug.'home',
								'uses' => $route_controller.'home']);
				Route::get('/{enc_id}',['as' => $route_slug.'index',
								'uses' => $route_controller.'index']);
								
				Route::get('/careerpost/{enc_id}',['as' => $route_slug.'cpost',
											 'uses' => $route_controller.'careerpost']);
										 
											 
		       	Route::get('/view/{enc_id}',['as' => $route_slug.'details',
											 'uses' => $route_controller.'view']);
											 
				Route::get('/application/{enc_id}',['as' => $route_slug.'application',
											 'uses' => $route_controller.'application']);
				...
				Route::get('deletepost/{enc_id}',['as' => $route_slug.'deletepost',
											  'uses' => $route_controller.'deletepost']);
											  
			    Route::get('live/{enc_id}',['as' => $route_slug.'live',
											  'uses' => $route_controller.'live']);
				Route::get('off/{enc_id}',['as' => $route_slug.'off',
											  'uses' => $route_controller.'off']);
