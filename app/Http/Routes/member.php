<?php
	...
	Route::group(array('prefix' => '/member','middleware' =>['front_member','general']), function()
	{
		...
		Route::GET('/update_profileimages',     ['as'=>$route_slug.'update_profileimages',          'uses'=>$module_controller.'update_profileimages']);
		...
		Route::post('/reply-review',           ['as'=>$route_slug.'reply_review',          'uses'=>$module_controller.'reply_review']);
		...
		Route::get('/coach_bookings/{id}',           ['as'=>$route_slug.'coach_bookings',          'uses'=>$module_controller.'coachBookings']);
        ...
        Route::get('/submit-review-qa/{id}',           ['as'=>$route_slug.'submitReviewQA',          'uses'=>$module_controller.'submitReviewQA']);
        Route::get('/submit-review-company/{id}',           ['as'=>$route_slug.'submitReviewCompany',          'uses'=>$module_controller.'submitReviewCompany']);
        Route::get('/submit-review-realisssues/{id}',           ['as'=>$route_slug.'submitReviewRealissues',          'uses'=>$module_controller.'submitReviewRealissues']);
		...
		Route::get('/revenue/{from}/{to}',					['as' => $route_slug.'revenue',		 'uses' => $module_controller.'revenue']);
		Route::get('/revenue_history',     ['as'=>$route_slug.'revenue_history',          'uses'=>$module_controller.'revenue_history']);
		Route::get('/reviews-ratings/{skill_id}',     ['as'=>$route_slug.'reviews-ratings',  'uses'=>$module_controller.'reviewsRatings']);
		Route::get('/reviews',     ['as'=>$route_slug.'reviews',          'uses'=>$module_controller.'reviewsNew']);
		Route::get('/allreviews',     ['as'=>$route_slug.'allreviews',          'uses'=>$module_controller.'allreviews']);
		Route::get('/upload_history',     ['as'=>$route_slug.'upload_history',          'uses'=>$module_controller.'upload_history']);
		
		Route::get('/interviewqna/{int_id}',     ['as'=>$route_slug.'interviewqna',          'uses'=>$module_controller.'interviewqna']);
		Route::get('/interviewscompanies/{int_id}',     ['as'=>$route_slug.'interviewscompanies',          'uses'=>$module_controller.'interviewscompanies']);
		
		Route::get('/realissuesqa/{int_id}',     ['as'=>$route_slug.'realissuesqa',          'uses'=>$module_controller.'realissuesqa']);
		
		
		
		Route::get('/interviewqa_manage/{int_id}',     ['as'=>$route_slug.'interviewqa_manage',          'uses'=>$module_controller.'interviewqa_manage']);
		
		Route::get('/interviewcompany_manage/{int_id}',     ['as'=>$route_slug.'interviewcompany_manage',          'uses'=>$module_controller.'interviewcompany_manage']);
		Route::get('/interviewrealissues_manage/{int_id}',     ['as'=>$route_slug.'interviewrealissues_manage',          'uses'=>$module_controller.'interviewrealissues_manage']);
		
			
			
		Route::get('/get_interview_qa',     ['as'=>$route_slug.'get_interview_qa',          'uses'=>$module_controller.'get_interview_qa']);
		Route::get('/get_realtime_issues',     ['as'=>$route_slug.'get_realtime_issues',          'uses'=>$module_controller.'get_realtime_issues']);
		Route::get('/get_company_issues',     ['as'=>$route_slug.'get_company_issues',          'uses'=>$module_controller.'get_company_issues']);
		Route::get('/manage_upload_history',     ['as'=>$route_slug.'upload_history',          'uses'=>$module_controller.'upload_history']);
		
		Route::get('/manage_upload_historys',     ['as'=>$route_slug.'upload_historys',          'uses'=>$module_controller.'upload_historys']);
		...
		// alert member section........
		 ...
		 Route::get('/update_interview_status',           ['as'=>$route_slug.'update_interview_status',          'uses'=>$module_controller.'update_interview_status']);
		 Route::get('/update_interview_available_status',           ['as'=>$route_slug.'update_interview_available_status',          'uses'=>$module_controller.'update_interview_available_status']);
        ...
        Route::get('/delete_purchase/{enc_id}',           ['as'=>$route_slug.'delete_purchase',          'uses'=>$module_controller.'delete_purchase']);
         ...
         Route::get('/mlearnlist',           ['as'=>$route_slug.'mlearnlist',          'uses'=>'Front\HomeController@mlearnlist']);
      ...
      Route::get('/editpersonal/{enc_id}',           ['as'=>$route_slug.'editpersonal',          'uses'=>$module_controller.'editpersonal']);
      
      Route::get('/addemplyeement/{enc_id}',           ['as'=>$route_slug.'addemplyeement',          'uses'=>$module_controller.'addemplyeement']);
      
       Route::get('/editemplyeement/{enc_id}',           ['as'=>$route_slug.'editemplyeement',          'uses'=>$module_controller.'editemplyeement']);
       
              Route::get('/delete_empylemet/{enc_id}',           ['as'=>$route_slug.'delete_empylemet',          'uses'=>$module_controller.'delete_empylemet']);
       
       Route::get('/editpro_save/{enc_id}',           ['as'=>$route_slug.'editpro_save',          'uses'=>$module_controller.'editpro_save']);
      
      
      Route::post('editpersonal_save',		 ['as' => $route_slug.'editpersonal_save','uses' => $module_controller.'editpersonal_save']);
      
      Route::post('addemplyeement_save',		 ['as' => $route_slug.'addemplyeement_save','uses' => $module_controller.'addemplyeement_save']);
      
      Route::post('editemplyeement_save',		 ['as' => $route_slug.'editemplyeement_save','uses' => $module_controller.'editemplyeement_save']);
      
            Route::post('edit_pro_savepro',		 ['as' => $route_slug.'edit_pro_savepro','uses' => $module_controller.'edit_pro_savepro']);
      
      
       Route::post('editeducation_save',		 ['as' => $route_slug.'editeducation_save','uses' => $module_controller.'editeducation_save']);
       Route::post('socailmplyeement_save',		 ['as' => $route_slug.'socailmplyeement_save','uses' => $module_controller.'socailmplyeement_save']);
       
             
 Route::post('youtubesave_save',		 ['as' => $route_slug.'youtubesave_save','uses' => $module_controller.'youtubesave_save']);
 
  Route::post('youtubesave_saveedit',		 ['as' => $route_slug.'youtubesave_saveedit','uses' => $module_controller.'youtubesave_saveedit']); 
  
    Route::post('yutub_compnaysave',		 ['as' => $route_slug.'yutub_compnaysave','uses' => $module_controller.'yutub_compnaysave']); 
  
       Route::post('youtubesave_saveeditcomp',		 ['as' => $route_slug.'youtubesave_saveeditcomp','uses' => $module_controller.'youtubesave_saveeditcomp']);
       
       
           Route::post('yutub_compnaysaveis',		 ['as' => $route_slug.'yutub_compnaysaveis','uses' => $module_controller.'yutub_compnaysaveis']); 
  
       Route::post('youtubesave_saveeditis',		 ['as' => $route_slug.'youtubesave_saveeditis','uses' => $module_controller.'youtubesave_saveeditis']);
