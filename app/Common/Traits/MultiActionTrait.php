...
trait MultiActionTrait
{
    ...
    /*public function delete($enc_id)
    {
        ...
        {
            Flash::error('Problem Occured While Deleting '.$this->module_title.'(s)');                   
        }
        return redirect()->back();
    }
    ...
    protected function _delete($enc_id)
    {
        ...
        $contact_enquiry = $this->BaseModel->where('id','=',$id)->delete();
    ...
    {
        $static_page= $this->BaseModel->where('id',$id)->delete();
