...
class UserDetailModel extends Model
{
    ...
    protected $fillable = ['user_id','qualification_id','passing_month','passing_year','marks_type','marks','specialization_id','category_id','current_work_location','other_state','country_id','other_city',];
