...
class MemberInterviewModel extends Model
{
    ...
    public function ref_book_details()
    {
        return $this->hasMany('App\Models\MultiReferenceBookModel','interview_id','id')->select(['*', DB::raw('GROUP_CONCAT(approve_status) as approve_status')])->groupBy('topic_name')->orderBy('id','DESC')->orderBy('approve_status','DESC');
    }
