...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require("{{url('/')}}/assets/pdfviewer/build/pdf.js");
}
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = "{{url('/')}}/assets/pdfviewer/web/images/";
  PDFJS.workerSrc = "{{url('/')}}/assets/pdfviewer/build/pdf.worker.js";
  PDFJS.cMapUrl = "{{url('/')}}/assets/pdfviewer/web/cmaps/";
